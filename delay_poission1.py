...
arrival_lambda = [0.001, 0.001, 0.001, 0.001]
...
plt.figure(1)
x = np.linspace(0.0, float(loops)/100.0, loops)
# plt.ylim(0, 0.3 * count)
# plt.gca().set_yscale('log')
plt.xlabel('Arrival rate up to (0.33, 0.42, 2.0 (x-axis), 1.34)')
